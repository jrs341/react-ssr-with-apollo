...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _jsxFileName='/Volumes/GITCLONES/react-ssr-with-apollo/src/components/LineChart.js';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=__webpack_require__(0);var _react2=_interopRequireDefault(_react);var _propTypes=__webpack_require__(1);var _propTypes2=_interopRequireDefault(_propTypes);__webpack_require__(25);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var LineChart=function(_Component){_inherits(LineChart,_Component);function LineChart(props){_classCallCheck(this,LineChart);var _this=_possibleConstructorReturn(this,(LineChart.__proto__||Object.getPrototypeOf(LineChart)).call(this,props));_this.state={};_this.makeAxis=_this.makeAxis.bind(_this);_this.makeMajorAxis=_this.makeMajorAxis.bind(_this);_this.makeMinorXAxis=_this.makeMinorXAxis.bind(_this);_this.makeMinorYAxis=_this.makeMinorYAxis.bind(_this);return _this;}_createClass(LineChart,[{key:'makeAxis',value:function makeAxis(){return _react2.default.createElement('g',{__source:{fileName:_jsxFileName,lineNumber:33}},this.makeMajorAxis(),this.makeMinorXAxis(),this.makeMinorYAxis());}},{key:'makeMajorAxis',value:function makeMajorAxis(){var _props=this.props,svgHeight=_props.svgHeight,svgWidth=_props.svgWidth;return[_react2.default.createElement('line',{key:'majorX',x1:'3',y1:svgHeight-10,x2:svgWidth,y2:svgHeight-10,style:{stroke:'black',strokeWidth:'.3'},__source:{fileName:_jsxFileName,lineNumber:45}}),_react2.default.createElement('line',{key:'majorY',x1:'5',y1:svgHeight-8,x2:'5',y2:'0',style:{stroke:'black',strokeWidth:'.3'},__source:{fileName:_jsxFileName,lineNumber:46}})];}},{key:'makeMinorXAxis',value:function makeMinorXAxis(){var svgWidth=this.props.svgWidth;var minorXAxis=[];for(var i=1;i<10;i++){if(i===1||i===2){i===1?minorXAxis.push(_react2.default.createElement('line',{key:'minorX'+i,x1:'3',y1:'2.08',x2:svgWidth,y2:'2.08',style:{stroke:'red',strokeWidth:'.2'},__source:{fileName:_jsxFileName,lineNumber:57}})):minorXAxis.push(_react2.default.createElement('line',{key:'minorX'+i,x1:'3',y1:'6',x2:svgWidth,y2:'6',style:{stroke:'orange',strokeWidth:'.1'},__source:{fileName:_jsxFileName,lineNumber:58}}));}else{minorXAxis.push(_react2.default.createElement('line',{key:'minorX'+i,x1:'3',y1:i*3,x2:svgWidth,y2:i*3,style:{stroke:'black',strokeWidth:'.1'},__source:{fileName:_jsxFileName,lineNumber:60}}));}}return minorXAxis;}},{key:'makeMinorYAxis',value:function makeMinorYAxis(){var _props2=this.props,data=_props2.data,svgHeight=_props2.svgHeight,svgWidth=_props2.svgWidth;var minorYAxis=[];for(var i=1;i<svgWidth/5;i++){if(i%2===0){minorYAxis.push(_react2.default.createElement('line',{key:'minorY'+i,x1:i*5+5,y1:svgHeight-8,x2:i*5+5,y2:'0',style:{stroke:'black',strokeWidth:'.1'},__source:{fileName:_jsxFileName,lineNumber:71}}));}else{minorYAxis.push(_react2.default.createElement('line',{key:'minorY'+i,x1:i*5+5,y1:svgHeight-8,x2:i*5+5,y2:'0',style:{stroke:'black',strokeDasharray:'1,.5',strokeWidth:'.1'},__source:{fileName:_jsxFileName,lineNumber:73}}));}}return minorYAxis;}},{key:'render',value:function render(){var _props3=this.props,data=_props3.data,svgHeight=_props3.svgHeight,svgWidth=_props3.svgWidth;var lastValue=data[data.length-1];var sixHour=Number(data[data.length-1].level)-Number(data[data.length-25].level);var twelveHour=Number(data[data.length-1].level)-Number(data[data.length-49].level);var twentyFourHour=Number(data[data.length-1].level)-Number(data[data.length-97].level);var fortyEightHour=Number(data[data.length-1].level)-Number(data[data.length-193].level);console.log('sixHour',twelveHour);var sixHourColor=sixHour<0?'green':sixHour===0?'yellow':'red';var twelveHourColor=twelveHour<0?'green':twelveHour===0?'yellow':'red';var twentyFourHourColor=twentyFourHour<0?'green':twentyFourHour===0?'yellow':'red';var fortyEightHourColor=fortyEightHour<0?'green':fortyEightHour===0?'yellow':'red';var sixY='';var sixHourArrow=sixHour<0?sixY='11.5,8 12.5,9 13.5,8':sixHour===0?sixY='0,0':sixY='11.5,8 12.5,7 13.5,8';var twelveY='';var twelveHourArrow=twelveHour<0?twelveY='16.5,8 17.5,9 18.5,8':twelveHour===0?twelveY='0,0':twelveY='16.5,8 17.5,7 18.5,8';var twentyFourY='';var twentyFourHourArrow=twentyFourHour<0?twentyFourY='22.5,8 23.5,9 24.5,8':twentyFourHour===0?twentyFourY='0,0':twentyFourY='22.5,8 23.5,7 24.5,8';var fortyEightY=void 0;var fortyEightHourArrow=fortyEightHour<0?fortyEightY='29.5,8 30.5,9 31.5,8':fortyEightHour===0?fortyEightY='0,0':fortyEightY='29.5,8 30.5,7 31.5,8';return _react2.default.createElement('svg',{viewBox:'0 0 '+svgWidth+' '+svgHeight,__source:{fileName:_jsxFileName,lineNumber:135}},data.map(function(point,i){return _react2.default.createElement('circle',{key:i,style:{stroke:'#2196F3',fill:'#2196F3'},cx:i/9.03+5,cy:(10-point.level)*3,r:'.05',__source:{fileName:_jsxFileName,lineNumber:137}});}),this.makeAxis(),_react2.default.createElement('rect',{x:'6',y:'0',width:'27',height:'10',style:{strokeWidth:'.2',stroke:'orange',fill:'white'},__source:{fileName:_jsxFileName,lineNumber:140}}),_react2.default.createElement('text',{x:'7',y:'2',style:{fill:'black',fontSize:'1.5'},__source:{fileName:_jsxFileName,lineNumber:141}},' Last Observation: ',lastValue.date.slice(0,16),' '),_react2.default.createElement('text',{x:'7',y:'4',style:{fill:'black',fontSize:'1.5'},__source:{fileName:_jsxFileName,lineNumber:142}},' Last Observed Value: ',lastValue.level,'  ft'),_react2.default.createElement('text',{x:'7',y:'6',style:{fill:'black',fontSize:'1.5'},__source:{fileName:_jsxFileName,lineNumber:143}},' Trend:  6hr  '),_react2.default.createElement('text',{x:'16',y:'6',style:{fill:'black',fontSize:'1.5'},__source:{fileName:_jsxFileName,lineNumber:144}},' 12hr '),_react2.default.createElement('text',{x:'22',y:'6',style:{fill:'black',fontSize:'1.5'},__source:{fileName:_jsxFileName,lineNumber:145}},' 24hr '),_react2.default.createElement('text',{x:'29',y:'6',style:{fill:'black',fontSize:'1.5'},__source:{fileName:_jsxFileName,lineNumber:146}},' 48hr '),_react2.default.createElement('line',{x1:'12.5',y1:'7',x2:'12.5',y2:'9',style:{stroke:''+sixHourColor,strokeWidth:'.2'},__source:{fileName:_jsxFileName,lineNumber:147}}),_react2.default.createElement('line',{x1:'17.5',y1:'7',x2:'17.5',y2:'9',style:{stroke:''+twelveHourColor,strokeWidth:'.2'},__source:{fileName:_jsxFileName,lineNumber:148}}),_react2.default.createElement('line',{x1:'23.5',y1:'7',x2:'23.5',y2:'9',style:{stroke:''+twentyFourHourColor,strokeWidth:'.2'},__source:{fileName:_jsxFileName,lineNumber:149}}),_react2.default.createElement('line',{x1:'30.5',y1:'7',x2:'30.5',y2:'9',style:{stroke:''+fortyEightHourColor,strokeWidth:'.2'},__source:{fileName:_jsxFileName,lineNumber:150}}),_react2.default.createElement('polyline',{points:sixY,style:{stroke:''+sixHourColor,strokeWidth:'.2',fill:'none'},__source:{fileName:_jsxFileName,lineNumber:151}}),_react2.default.createElement('polyline',{points:twelveY,style:{stroke:''+twelveHourColor,strokeWidth:'.2',fill:'none'},__source:{fileName:_jsxFileName,lineNumber:152}}),_react2.default.createElement('polyline',{points:twentyFourY,style:{stroke:''+twentyFourHourColor,strokeWidth:'.2',fill:'none'},__source:{fileName:_jsxFileName,lineNumber:153}}),_react2.default.createElement('polyline',{points:fortyEightY,style:{stroke:''+fortyEightHourColor,strokeWidth:'.2',fill:'none'},__source:{fileName:_jsxFileName,lineNumber:154}}));}}]);return LineChart;}(_react.Component);LineChart.propTypes={};LineChart.defaultProps={data:[],color:'#2196F3',svgHeight:40,svgWidth:75};exports.default=LineChart;
